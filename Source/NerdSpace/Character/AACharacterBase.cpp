...
AAACharacterBase::AAACharacterBase()
{
	...
	// Zoom
	static ConstructorHelpers::FObjectFinder<UAACharacterControlData> ZoomOutDataRef(TEXT("/Script/NerdSpace.AACharacterControlData'/Game/CharacterControl/AAC_ZoomOut.AAC_ZoomOut'"));
	if (ZoomOutDataRef.Object)
	{
		CharacterControlManager.Add(ECharacterZoomType::ZoomOut, ZoomOutDataRef.Object);
	}

	static ConstructorHelpers::FObjectFinder<UAACharacterControlData> ZoomInDataRef(TEXT("/Script/NerdSpace.AACharacterControlData'/Game/CharacterControl/AAC_ZoomIn.AAC_ZoomIn'"));
